...
enum L10n {
    ...
    private static let strings: [String: [String: String]] = [
        ...
        "de": [
            ...
            "whatsnew.body": "• Der Layout-Umschalt-Hotkey (Strg+Umschalt und andere Zweitasten-Kombos) reagiert jetzt zuverlässig, auch wenn du den Akkord etwas länger hältst.\n• Neu: «RuSwitcher teilen» im Menü — erzähl es weiter.\n• Klarere Assistent-, Einstellungs- und Update-Texte in allen 16 Sprachen.\n• Plus die Korrekturen aus 3.0.1.",
        ...
        "fr": [
            ...
            "whatsnew.body": "• Le raccourci de changement de disposition (Ctrl+Maj et autres combos à deux touches) se déclenche désormais de façon fiable, même en le maintenant un peu plus longtemps.\n• Nouveau : « Partager RuSwitcher » dans le menu.\n• Assistant, réglages et messages de mise à jour plus clairs dans les 16 langues.\n• Plus les corrections de la 3.0.1.",
        ...
        "es": [
            ...
            "whatsnew.body": "• El atajo para cambiar de distribución (Ctrl+Mayús y otras combinaciones de dos teclas) ahora funciona de forma fiable, aunque lo mantengas un poco más.\n• Nuevo: «Compartir RuSwitcher» en el menú.\n• Asistente, ajustes y mensajes de actualización más claros en los 16 idiomas.\n• Además de las correcciones de la 3.0.1.",
        ...
        "pt": [
            ...
            "whatsnew.body": "• O atalho de troca de layout (Ctrl+Shift e outras combinações de duas teclas) agora funciona de forma confiável, mesmo se você segurar um pouco mais.\n• Novo: «Compartilhar RuSwitcher» no menu.\n• Assistente, ajustes e mensagens de atualização mais claros nos 16 idiomas.\n• Além das correções da 3.0.1.",
            "whatsnew.more": "Notas completas",
            "menu.quit": "Sair",
        ...
        "zh": [
            ...
            "whatsnew.body": "• 切换布局的快捷键（Ctrl+Shift 及其他双键组合）现在能可靠触发，即使按住稍久也没问题。\n• 新增：菜单中的「分享 RuSwitcher」。\n• 16 种语言的向导、设置和更新提示更清晰。\n• 以及 3.0.1 的修复。",
        ...
        "ja": [
            ...
            "whatsnew.body": "• レイアウト切替のホットキー（Ctrl+Shift などの2キー組み合わせ）が、少し長く押しても確実に反応するようになりました。\n• 新機能：メニューの「RuSwitcher を共有」。\n• 16 言語すべてでウィザード・設定・更新メッセージをより明確に。\n• さらに 3.0.1 の修正も含みます。",
        ...
        "uk": [
            ...
            "whatsnew.body": "• Хоткей зміни розкладки (Ctrl+Shift та інші комбо з двох клавіш) тепер спрацьовує надійно — навіть якщо потримати акорд трохи довше.\n• Нове: «Поділитися RuSwitcher» у меню.\n• Зрозуміліші майстер, налаштування та повідомлення оновлення всіма 16 мовами.\n• А також виправлення з 3.0.1.",
        ...
        "be": [
            ...
            "whatsnew.body": "• Хоткей змены раскладкі (Ctrl+Shift і іншыя камбо з дзвюх клавіш) цяпер спрацоўвае надзейна — нават калі патрымаць акорд крыху даўжэй.\n• Новае: «Падзяліцца RuSwitcher» у меню.\n• Зразумелейшыя майстар, налады і паведамленні абнаўлення на ўсіх 16 мовах.\n• А таксама выпраўленні з 3.0.1.",
        ...
        "pl": [
            ...
            "whatsnew.body": "• Skrót przełączania układu (Ctrl+Shift i inne kombinacje dwuklawiszowe) działa teraz niezawodnie, nawet gdy przytrzymasz go chwilę dłużej.\n• Nowość: «Udostępnij RuSwitcher» w menu.\n• Czytelniejszy kreator, ustawienia i komunikaty aktualizacji we wszystkich 16 językach.\n• Plus poprawki z 3.0.1.",
        ...
        "el": [
            ...
            "whatsnew.body": "• Η συντόμευση αλλαγής διάταξης (Ctrl+Shift και άλλοι συνδυασμοί δύο πλήκτρων) ενεργοποιείται τώρα αξιόπιστα, ακόμη κι αν την κρατήσετε λίγο περισσότερο.\n• Νέο: «Κοινοποίηση RuSwitcher» στο μενού.\n• Πιο σαφή μηνύματα οδηγού, ρυθμίσεων και ενημερώσεων σε όλες τις 16 γλώσσες.\n• Καθώς και οι διορθώσεις της 3.0.1.",
        ...
        "bg": [
            ...
            "whatsnew.body": "• Клавишът за смяна на подредбата (Ctrl+Shift и други комбинации от два клавиша) вече се задейства надеждно, дори ако задържите малко по-дълго.\n• Ново: «Споделяне на RuSwitcher» в менюто.\n• По-ясни съветник, настройки и съобщения за обновяване на всичките 16 езика.\n• Плюс корекциите от 3.0.1.",
        ...
        "hy": [
            ...
            "whatsnew.body": "• Դասավորության փոխարկման ստեղնը (Ctrl+Shift և երկստեղնանի այլ համակցություններ) այժմ գործում է հուսալիորեն՝ նույնիսկ եթե մի փոքր ավելի երկար պահեք։\n• Նոր՝ «Կիսվել RuSwitcher-ով» ընտրացանկում։\n• Ավելի հասկանալի օգնականի, կարգավորումների և թարմացման հաղորդագրություններ բոլոր 16 լեզուներով։\n• Նաև 3.0.1-ի ուղղումները։",
        ...
        "ka": [
            ...
            "whatsnew.body": "• განლაგების გადართვის მალსახმობი (Ctrl+Shift და ორკლავიშიანი სხვა კომბინაციები) ახლა საიმედოდ ირთვება, თუნდაც ცოტა ხანს გეჭიროთ.\n• ახალი: „RuSwitcher-ის გაზიარება“ მენიუში.\n• უფრო გასაგები ოსტატი, პარამეტრები და განახლების შეტყობინებები 16-ვე ენაზე.\n• ასევე 3.0.1-ის შესწორებები.",
